    ...
    return (
        <div className="w-full max-w-md bg-white/60 rounded-3xl shadow-lg p-8 flex flex-col items-center">
            ...
            <div className="flex items-center gap-6 mb-6 w-full">
                ...
                <span className="text-3xl font-bold text-gray-300 hover:text-black">Limit</span>
            ...
            <div className="w-full bg-[#f6f6f6] rounded-2xl p-6 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button className="flex items-center bg-green-400 rounded-full px-4 py-2 gap-2 shadow font-semibold text-black">
                        Select token
                        <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" /></svg>
                    </button>
                </div>
