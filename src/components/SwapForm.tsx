    ...
    return (
        <div className="w-max bg-[#f6f6f6] backdrop-blur-sm rounded-3xl shadow-lg p-0 flex flex-col items-center">
            ...
            <div className="flex items-center gap-6 mb-2 w-full px-8 pt-8">
                ...
                <span className="text-3xl font-bold text-gray-300 hover:text-black cursor-pointer transition-colors">Limit</span>
            ...
            <div className="w-full bg-[#f6f6f6] rounded-2xl p-0 flex flex-col gap-0">
                ...
                <div className="flex flex-col gap-1 border-b border-gray-200 px-6 py-4">
                    ...
                    <span className="text-right text-sm text-gray-400 pr-2">{fromToken ? formatNumber(fromAmount, fromToken.decimals) : '0'}</span>
                </div>
                ...
                <div className="flex flex-col gap-1 px-6 py-4">
                    ...
                    <span className="text-right text-sm text-gray-400 pr-2">{toToken ? formatNumber(toAmount, toToken.decimals) : '0'}</span>
                </div>
