        ...
        <DropdownMenu.Root>
            <DropdownMenu.Trigger asChild>
                <button
                    ...
                    disabled={disabled}
                    className={`flex items-center bg-white rounded-full px-2 md:px-4 py-2 gap-2 shadow-md font-semibold text-black border border-gray-200 transition-all duration-200 ${disabled
                ...
                >
                    {selectedToken ? (
                        ...
                        <span className="text-sm md:text-base">Select token</span>
                    )}
