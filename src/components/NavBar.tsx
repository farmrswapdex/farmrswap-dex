            ...
            <div className="md:hidden flex items-center">
                <DropdownMenu.Root>
                    ...
                    >
                        ...
                        <DropdownMenu.Item asChild>
                            <NavLink to="/farms" className={({ isActive }) => `flex items-center gap-2 px-4 py-2 text-lg hover:bg-white/10 ${isActive ? 'text-red-400' : 'text-[#b3b9d8]'}`}>Farms</NavLink>
                        </DropdownMenu.Item>
                        <DropdownMenu.Item asChild>
                            <NavLink to="/explore" className={({ isActive }) => `flex items-center gap-2 px-4 py-2 text-lg hover:bg-white/10 ${isActive ? 'text-red-400' : 'text-[#b3b9d8]'}`}>Explore</NavLink>
                        </DropdownMenu.Item>
                        <DropdownMenu.Item asChild>
                            <NavLink to="/bridge" className={({ isActive }) => `flex items-center gap-2 px-4 py-2 text-lg hover:bg-white/10 ${isActive ? 'text-red-400' : 'text-[#b3b9d8]'}`}>Bridge</NavLink>
                        </DropdownMenu.Item>
                        <DropdownMenu.Separator className="h-[1px] bg-gray-700 my-2" />
                        <DropdownMenu.Item onSelect={() => setIsSearchModalOpen(true)} className="flex items-center gap-2 px-4 py-2 text-lg text-[#b3b9d8] hover:bg-white/10 cursor-pointer">
