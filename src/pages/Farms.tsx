...
const Farms = () => {
  return (
    <div className="w-full min-h-screen bg-[#a7d8f5] flex flex-col justify-between relative">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-full px-8 pt-20 pb-8 flex-1 relative">
        ...
        <div className="flex-1 flex flex-col items-center justify-center z-10">
          <h1
            className="text-5xl md:text-6xl font-extrabold text-[#2d3e3e] drop-shadow-lg text-center tracking-wide"
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full max-w-3xl justify-center">
          <div className="bg-[#f6f6f6] rounded-2xl shadow-md flex-1 p-6 flex flex-col justify-between min-w-[250px]">
            ...
            <p className="text-[#b0c4d4] mb-4">
              Deposit your liquidity provider tokens to earn FARM rewards.
            </p>
            <FarmForm />
          </div>
        </div>
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center max-w-md mx-4 border-4 border-[#a7d8f5]">
